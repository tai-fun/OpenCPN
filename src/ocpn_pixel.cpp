/******************************************************************************
 * $Id: ocpn_pixel.cpp,v 1.1 2007/06/03 16:03:59 dsr Exp $
 *
 * Project:  OpenCP
...
CPL_CVSID("$Id: ocpn_pixel.cpp,v 1.1 2007/06/03 16:03:59 dsr Exp $");
...
unsigned char *PixelCache::GetpData(void)
{
    return pData;
}
