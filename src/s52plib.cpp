 ...
 * On text objects, define a bounding box to include text extents fully.
 * This forces full redraw on viewport intersection, so that text objects scrolling onto the screen are always rendered.
 *
